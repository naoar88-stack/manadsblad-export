...
const ALLOWED_ORIGIN = process.env.ALLOWED_ORIGIN || 'https://manadsblad.vercel.app';
...
app.get('/', (_req, res) => res.json({
  name:    'manadsblad-export',
  version: '1.0.0',
  status:  'ok',
  endpoints: ['/health', 'POST /api/export'],
}));
...
app.listen(PORT, () => console.log(`\u2705 manadsblad-export k\u00f6r p\u00e5 port ${PORT} \u2022 origin: ${ALLOWED_ORIGIN}`));
